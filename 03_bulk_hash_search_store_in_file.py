...
output_file_path = 'found_passwords.txt'
...
found_passwords = search_hashes(hash_db_file_path, md5_to_search)

# Write the results to the output file and print them
with open(output_file_path, 'w') as output_file:
    for md5_hash in md5_to_search:
        password = found_passwords.get(md5_hash, "Password not found.")
        output_line = f"{md5_hash}:{password}\n"
